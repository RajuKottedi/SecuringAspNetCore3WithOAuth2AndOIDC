...
namespace Marvin.IDP
{
    public class Startup
    {
        ...
        {
            var marvinIDPDataDBConnectionString = "Server=AI;Database=MarvinIDPDataDB;Trusted_Connection=True;";
            ...
            builder.AddConfigurationStore(options =>
            {
                options.ConfigureDbContext = builder =>
                    builder.UseSqlServer(marvinIDPDataDBConnectionString, options =>
        ...
        {
            string thumbPrint = "7d722d302d2e439ef3fe31d6932ceb3f8f5f335d";
